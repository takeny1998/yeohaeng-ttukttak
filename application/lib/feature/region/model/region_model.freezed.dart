...
abstract class $RegionModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, List<RegionModel>? children});
}
...
class _$RegionModelImpl implements _RegionModel {
  const _$RegionModelImpl(
      {required this.id, required this.name, final List<RegionModel>? children})
      : _children = children;
  ...
  @override
  String toString() {
    return 'RegionModel(id: $id, name: $name, children: $children)';
  }
