...
public class OAuthConfig {
    ...
    public OAuthService googleOAuthService(
            GoogleOAuthProvider provider, UserRepository userRepository, JwtService jwtService) {
    ...
    public OAuthService appleOAuthService(
            AppleOAuthProvider provider, UserRepository userRepository, JwtService jwtService) {
