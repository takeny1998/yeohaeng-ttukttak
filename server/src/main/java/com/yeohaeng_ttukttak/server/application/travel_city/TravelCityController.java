...
import com.yeohaeng_ttukttak.server.application.travel_city.dto.TravelAndCityListResponse;
...
public class TravelCityController {
    ...
    @PostMapping("/{cityId}")
    @Authorization
    public ServerResponse<TravelAndCityListResponse> addCity(
        ...
        return new ServerResponse<>(new TravelAndCityListResponse(travelDto, cityDtoList));
    }
